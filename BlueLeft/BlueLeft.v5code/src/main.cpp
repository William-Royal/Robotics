...
void SensorControl()
{
  ...
  {
    if(Vision6.largestObject.centerX < 140 && Vision6.largestObject.centerX > 110)
    {
      driveX += -5;
    }
    else if (Vision6.largestObject.centerX <= 110 && Vision6.largestObject.centerX > 50)
    {
      driveX += -10;
    }
    else if(Vision6.largestObject.centerX > 160 && Vision6.largestObject.centerX < 190)
    {
      driveX += 5;
    }
    else if (Vision6.largestObject.centerX >= 190 && Vision6.largestObject.centerX < 250)
    {
      driveX += 10; 
    }
  }
